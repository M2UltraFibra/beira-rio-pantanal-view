...
import { Fish, Boat, Mountain, TreePine } from "lucide-react";
...
const ActivitiesSection = () => {
  const activities = [
    ...
    {
      icon: <Boat size={24} className="text-pousada-green" />,
    ...
    {
      icon: <TreePine size={24} className="text-pousada-green" />,
    ...
    {
      icon: <Mountain size={24} className="text-pousada-green" />,
