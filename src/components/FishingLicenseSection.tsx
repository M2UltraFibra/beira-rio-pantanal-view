        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
                            Todo pescador com mais de 18 anos precisa ter a
              carteira de pesca                amadora para praticar a atividade
              legalmente no Brasil. A licença é                obrigatória tanto
              para pesca embarcada quanto desembarcada.            {" "}
            </p>
                       {" "}
            <p className="text-muted-foreground mb-6">
                            Obtenha sua licença de forma rápida e 100% online
              através do portal                oficial do governo.            {" "}
            </p>
                     {" "}
          </div>
                   {" "}
