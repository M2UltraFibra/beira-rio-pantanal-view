          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" aria-label="TikTok" className="hover:text-white/70 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M16.6 5c.2-1.7 1.5-3 3.3-3h.1v4.4c-.3 0-.6.1-.9.1-1.1 0-2.2-.4-3-1v4.5c0 4.4-3.6 8-8 8-1.6 0-3-.5-4.3-1.3 1.5 1.5 3.5 2.3 5.8 2.3 4.4 0 8-3.6 8-8v-4.5c.8.6 1.9 1 3 1 .3 0 .6 0 .9-.1v-4.4c-2.3 0-4.3-1.4-5-3.5V5zm-1.6 5V9c-3.9-.3-6.9 2.7-6.9 6.6 0 1.3.4 2.5 1 3.6v-4.9c.2-2.9 2.6-5.3 5.9-5.3z"/>
                </svg>
              </a>
